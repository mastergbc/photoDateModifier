...
namespace MetadataExtractor.Formats.Jpeg
{
    ...
    public static class JpegSegmentExtension
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static int DecodePayloadLength(this JpegSegment objJpeg, byte highByte, byte lowByte)
        {
        ...
        public static byte[] EncodePayloadLength(this JpegSegment objJpeg, int payloadLength)
        {
